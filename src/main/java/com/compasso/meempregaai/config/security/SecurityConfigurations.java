    ...
    protected void configure(HttpSecurity http) throws Exception {
      ...
      //  http.authorizeRequests()
        .authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET, "/empregado/*/contratos").hasRole("EMPREGADO")
                ...
                .antMatchers(HttpMethod.POST, "/empregador/*/curtir").hasRole("EMPREGADOR")
                .antMatchers(HttpMethod.POST, "/vaga").hasRole("EMPREGADOR")
                .antMatchers(HttpMethod.POST, "/empregador/*/contratar/*").hasRole("EMPREGADOR")
                .antMatchers(HttpMethod.GET, "/empregador/*/contratos").hasRole("EMPREGADOR")
                .antMatchers(HttpMethod.PUT, "/empregador/*").hasRole("EMPREGADOR")
                .antMatchers(HttpMethod.DELETE, "/vaga/*").hasRole("EMPREGADOR")
                .antMatchers(HttpMethod.DELETE, "/empregador/*").hasRole("EMPREGADOR")
                .antMatchers(HttpMethod.DELETE, "/empregador/contrato/*").hasRole("EMPREGADOR")
