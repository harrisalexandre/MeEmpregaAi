...
public class SecurityConfigurations extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.POST, "/empregado/*/curtir").hasRole("EMPREGADO")
                ...
                .antMatchers(HttpMethod.GET, "/curriculo/*").permitAll()
                .antMatchers(HttpMethod.POST, "/curriculo").hasRole("EMPREGADO")
                .antMatchers(HttpMethod.DELETE, "/curriculo/*").hasRole("EMPREGADO")
